...
from api.apikey_auth import apikey_auth
...
async def send_conversation(request: Request, credentials: HTTPAuthorizationCredentials = Security(security_scheme)):
    ...
    # Map API key to actual ChatGPT token if it's a generated API key
    req_token = apikey_auth.validate_and_map_apikey(provided_token)
